...
public class User {
    ...
    //funcion que permite verificar que el desencriptado y el logion fue exitoso
    @Override
    public int hashCode(){ //nos permite revisar en que nivel está nuestra encriptación.
        final int prime = 31;
        int result = 1;
